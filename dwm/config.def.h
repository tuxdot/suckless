...
static const unsigned int systrayspaceing = 2;	/* systray spacing */
...
static const char col_main[]        = "#f4bf75";
...
/* tagging */
static const char *tags[] = { "web", "term", "chat", "music", "code", "game", "mov", "conf", "tmp" };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray1, "-sf", col_main, NULL };
